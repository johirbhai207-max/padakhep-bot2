...
# ৫. সাইডবার - এখানে পরিবর্তন করা হয়েছে (selectbox)
...
# multiselect এর বদলে selectbox ব্যবহার করা হয়েছে
            ...
            with st.spinner("গাইডলাইন বিশ্লেষণ করছি..."):
                ...
                while not success and attempts < len(VALID_KEYS):
                    try:
                        configure_key()
                        current_files = []
                        # শুধুমাত্র সিলেক্ট করা ফোল্ডারটির ফাইল আপলোড হবে
